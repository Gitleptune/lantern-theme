  ...
  let s:guishade0 = "#291812"
  let s:guishade1 = "#442212"
  let s:guishade2 = "#5e2b13"
  let s:guishade3 = "#793513"
  let s:guishade4 = "#933e14"
  let s:guishade5 = "#ae4814"
  let s:guishade6 = "#c85115"
  let s:guishade7 = "#e35b15"
  let s:guiaccent0 = "#e04220"
  let s:guiaccent1 = "#f99666"
  let s:guiaccent2 = "#fabc2c"
  let s:guiaccent3 = "#82a23a"
  let s:guiaccent4 = "#66a4a4"
  let s:guiaccent5 = "#4395a3"
  let s:guiaccent6 = "#e4cbb3"
  let s:guiaccent7 = "#b666e6"
  let s:ctermshade0 = 234
  let s:ctermshade1 = 58
  let s:ctermshade2 = 94
  let s:ctermshade3 = 94
  let s:ctermshade4 = 130
  let s:ctermshade5 = 130
  let s:ctermshade6 = 172
  let s:ctermshade7 = 172
  let s:ctermaccent0 = 167
  let s:ctermaccent1 = 216
  let s:ctermaccent2 = 221
  let s:ctermaccent3 = 143
